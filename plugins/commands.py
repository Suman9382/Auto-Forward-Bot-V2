...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/use_full_shortbot')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/Hasjsgdkd_bot'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/use_full_shortbot')
        ],[
